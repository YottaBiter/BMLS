...
urlpatterns = [
    ...
    path('staff_subjects', StaffViews.staff_subjects,name="staff_subjects"),
    path('staff_subject_details', StaffViews.staff_subject_details,name="staff_subject_details"),
    path('staff_take_assignment', StaffViews.staff_take_assignment, name="staff_take_assignment"),
    path('staff_take_assignment_save', StaffViews.staff_take_assignment_save, name="staff_take_assignment_save"),
    path('staff_take_quiz', StaffViews.staff_take_quiz, name="staff_take_quiz"),
    path('staff_take_quiz_save', StaffViews.staff_take_quiz_save, name="staff_take_quiz_save"),
    ...
    path('student_subject',StudentViews.student_subject,name="student_subject"),
    path('s_quizz',StudentViews.s_quizz,name="s_quizz"),
    path('s_quiz_view',StudentViews.s_quiz_view,name="s_quiz_view"),
    path('student_assignment',StudentViews.student_assignment,name="student_assignment"),
    path('student_assignment_view',StudentViews.student_assignment_view,name="student_assignment_view"),
    path('student_quiz_view',StudentViews.student_quiz_view,name="student_quiz_view"),
